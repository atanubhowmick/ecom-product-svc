 ...
 * 
 */
package deb.atanu.ecom.product.service;
...
import deb.atanu.ecom.product.annotation.LogMethodCall;
import deb.atanu.ecom.product.constant.ErrorCode;
import deb.atanu.ecom.product.constant.ProductConstant;
import deb.atanu.ecom.product.constant.StatusEnum;
import deb.atanu.ecom.product.dto.BrandDetails;
import deb.atanu.ecom.product.dto.CategoryDetails;
import deb.atanu.ecom.product.dto.ColourDetails;
import deb.atanu.ecom.product.dto.ProductDetails;
import deb.atanu.ecom.product.dto.QueryPageable;
import deb.atanu.ecom.product.entity.AvailableProductEntity;
import deb.atanu.ecom.product.entity.BrandEntity;
import deb.atanu.ecom.product.entity.CategoryEntity;
import deb.atanu.ecom.product.entity.ColourEntity;
import deb.atanu.ecom.product.entity.ProductEntity;
import deb.atanu.ecom.product.exception.ProductException;
import deb.atanu.ecom.product.repository.ProductRepository;
import deb.atanu.ecom.product.repository.QueryPageableSpecification;
import deb.atanu.ecom.product.util.ProductUtil;
